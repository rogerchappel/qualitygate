...
Replace this section with the supported versions for `qualitygate`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `qualitygate` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in qualitygate.
